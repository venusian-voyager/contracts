...
class ModelIdentifier
{
     ...
     *
     * @var class-string<\Voyager\Database\Instrument\Model>|string|null
     */
    public $class;
     ...
     *
     * @var class-string<\Voyager\Database\Instrument\Collection>|null
     */
     ...
     *
     * @param  class-string<\Voyager\Database\Instrument\Model>|null  $class
     * @param  mixed  $id
